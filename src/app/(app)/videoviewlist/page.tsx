            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn the basics of JavaScript, including variables, data
                  types, and how to use them in your programs.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn the basics of building web applications with Node.js and
          ...
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn how to create a RESTful API using Node.js and the
          ...
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Discover how to build mobile applications using React Native
          ...
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn how to create and use custom hooks to share logic across
          ...
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn how to build robust and scalable web applications using
          ...
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn how to build dynamic and interactive user interfaces
                  with React and the D3.js data visualization library.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn how to implement user authentication in Node.js
                  applications using the Passport.js middleware.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn how to create stunning visualizations and dashboards
          ...
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn how to create real-time applications using Socket.IO for
          ...
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Learn how to create captivating animations and transitions
                  using CSS for dynamic web experiences.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full max-w-3xl gap-x-4 md:flex">
            ...
            <div className="flex gap-x-2 md:w-7/12">
              ...
              <div className="w-full">
                ...
                <p className="mt-2 hidden text-sm md:block">
                  Explore advanced patterns and techniques for building scalable
