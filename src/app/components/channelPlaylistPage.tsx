          ...
          <div className="px-4 pb-4">
            ...
            <div className="grid gap-4 pt-2 sm:grid-cols-[repeat(auto-fit,_minmax(400px,_1fr))]">
              ...
              <div className="w-full">
                ...
                <p className="flex text-sm text-gray-200">
                  Learn the core concepts and fundamentals of JavaScript
              ...
              <div className="w-full">
                ...
                <p className="flex text-sm text-gray-200">
                  Dive into TypeScript for enhanced type safety and scalable
              ...
              <div className="w-full">
                ...
                <p className="flex text-sm text-gray-200">
                  Explore various state management techniques in React
                  applications.
                </p>
              </div>
              <div className="w-full">
