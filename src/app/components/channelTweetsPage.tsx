            ...
            <div className="py-4">
              <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                  ...
                  <p className="mb-2">
                    Exploring the latest features in JavaScript ES11! The
                    language keeps evolving. 💡 #JavaScript #ES11
                  </p>
              ...
              <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                  ...
                  <p className="mb-2">
                    Embracing the benefits of TypeScript for stronger, more
              ...
              <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                  ...
                  <p className="mb-2">
                    Styling made easy with Tailwind CSS! Rapidly build
              ...
              <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                  ...
                  <p className="mb-2">
                    Building dynamic user interfaces with React! The go-to
              ...
              <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                  ...
                  <p className="mb-2">
                    Next.js makes server-side rendering a breeze! Boost your
              ...
              <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                  ...
                  <p className="mb-2">
                    Mastering TypeScript: From basics to advanced concepts.
              ...
              <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                  ...
                  <p className="mb-2">
                    Simplify your CSS workflow with Tailwind CSS. Effortless
              ...
              <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                  ...
                  <p className="mb-2">
                    Optimize server-side rendering with Next.js. Improve
