...
export default function EditVideoPopup({onActiveTabChange}) {
  return (
        ...
        <div className="mb-6 flex flex-col gap-y-4">
          ...
          <div className="w-full">
            ...
            >
              ...
              applications, providing practical insights and best practices for
              effectively managing data flow. This book equips developers with
              the knowledge and skills needed to architect robust and
