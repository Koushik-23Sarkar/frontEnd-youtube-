...
export default function LoginPage() {
  ...
  const onsubmit = async (data: { email: string; password: string; } | undefined)=>{
    console.log(data);
    ...
    <div className="h-screen overflow-y-auto bg-[#121212] text-white">
      <div className="mx-auto my-8 flex w-full max-w-sm flex-col px-4">
        ...
        <input
          ...
          className="mb-4 rounded-lg border bg-transparent px-3 py-2"
        />
        <button onClick={()=>onsubmit({email:email,password:password})} className="bg-[#ae7aff] px-4 py-3 text-black">
          Sign up with Email
        </button>
      </div>
    </div>
