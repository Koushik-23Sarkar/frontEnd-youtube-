  ...
  return (
    <div className="h-screen overflow-y-auto bg-[#121212] text-white">
      ...
      <div className="flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
        ...
        {activeTab == activeTabStatus.editPopup && <EditVideoPopup onActiveTabChange={handleActiveTab} />}
        {activeTab == activeTabStatus.deletePopup && <DeleteVideoPopup onActiveTabChange={handleActiveTab} />}
      </div>
    </div>
  );
}
